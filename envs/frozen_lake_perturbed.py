...
class FrozenLakePerturbedEnv(Env):
    """
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, desc=None, map_name="4x4", is_slippery=True, safe_factor=0.3):
        ...
        self.p_in_direction = safe_factor
                    ...
                    if letter in b"GH":
                        ...
                        if is_slippery:
                            for b in [(a - 1) % 4, a, (a + 1) % 4]:
                                if b == a:
                                    li.append(
                                        (self.p_in_direction, *update_probability_matrix(row, col, b))
                                    )
                                else:
                                    li.append(
                                        ((1-self.p_in_direction)/2, *update_probability_matrix(row, col, b))
                                    )
                        else:

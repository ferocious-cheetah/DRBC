...
class AntPerturbedEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        self.hip_joint_damping = 1.0
        self.ankle_joint_damping = 1.0
    ...
    def reset(
        ...
        *,
        ...
        use_xml: bool = False,
        gravity: float = -9.81,
        hip_joint_stiffness: float = 0.0,
        ankle_joint_stiffness: float = 0.0,
        hip_actuator_ctrlrange: Tuple[float, float] = (-1.0, 1.0),
        ankle_actuator_ctrlrange: Tuple[float, float] = (-1.0, 1.0),
        hip_joint_damping_p: float = 0.0,
        ankle_joint_damping_p: float = 0.0,
        hip_joint_frictionloss: float = 0.0,
        ankle_joint_frictionloss: float = 0.0
    ):
        ...
        # perturb hip joint stiffness*
        model.jnt_stiffness[1] = hip_joint_stiffness
        model.jnt_stiffness[3] = hip_joint_stiffness
        model.jnt_stiffness[5] = hip_joint_stiffness
        model.jnt_stiffness[7] = hip_joint_stiffness
        # perturb ankle joint stiffness*
        model.jnt_stiffness[2] = ankle_joint_stiffness
        model.jnt_stiffness[4] = ankle_joint_stiffness
        model.jnt_stiffness[6] = ankle_joint_stiffness
        model.jnt_stiffness[8] = ankle_joint_stiffness
        # perturb hip actuator (controller) control range*
        model.actuator_ctrllimited[0] = self.actuator_ctrllimited
        model.actuator_ctrlrange[0] = [hip_actuator_ctrlrange[0],
                                        hip_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[2] = self.actuator_ctrllimited
        model.actuator_ctrlrange[2] = [hip_actuator_ctrlrange[0],
                                        hip_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[4] = self.actuator_ctrllimited
        model.actuator_ctrlrange[4] = [hip_actuator_ctrlrange[0],
                                        hip_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[6] = self.actuator_ctrllimited
        model.actuator_ctrlrange[6] = [hip_actuator_ctrlrange[0],
                                        hip_actuator_ctrlrange[1]]
        # perturb hip actuator (controller) control range*
        model.actuator_ctrllimited[1] = self.actuator_ctrllimited
        model.actuator_ctrlrange[1] = [ankle_actuator_ctrlrange[0],
                                        ankle_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[3] = self.actuator_ctrllimited
        model.actuator_ctrlrange[3] = [ankle_actuator_ctrlrange[0],
                                        ankle_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[5] = self.actuator_ctrllimited
        model.actuator_ctrlrange[5] = [ankle_actuator_ctrlrange[0],
                                        ankle_actuator_ctrlrange[1]]
        model.actuator_ctrllimited[7] = self.actuator_ctrllimited
        model.actuator_ctrlrange[7] = [ankle_actuator_ctrlrange[0],
                                        ankle_actuator_ctrlrange[1]]
        # perturb hip joint damping in percentage
        model.dof_damping[6] = self.hip_joint_damping * (1 + hip_joint_damping_p) 
        model.dof_damping[8] = self.hip_joint_damping * (1 + hip_joint_damping_p) 
        model.dof_damping[10] = self.hip_joint_damping * (1 + hip_joint_damping_p) 
        model.dof_damping[12] = self.hip_joint_damping * (1 + hip_joint_damping_p) 
        # perturb ankle joint damping in percentage
        model.dof_damping[7] = self.ankle_joint_damping * (1 + ankle_joint_damping_p) 
        model.dof_damping[9] = self.ankle_joint_damping * (1 + ankle_joint_damping_p) 
        model.dof_damping[11] = self.ankle_joint_damping * (1 + ankle_joint_damping_p) 
        model.dof_damping[13] = self.ankle_joint_damping * (1 + ankle_joint_damping_p) 

        # perturb hip joint frictionloss
        model.dof_frictionloss[6] = hip_joint_frictionloss
        model.dof_frictionloss[8] = hip_joint_frictionloss
        model.dof_frictionloss[10] = hip_joint_frictionloss
        model.dof_frictionloss[12] = hip_joint_frictionloss

        # perturb ankle joint frictionloss
        model.dof_frictionloss[7] = ankle_joint_frictionloss
        model.dof_frictionloss[9] = ankle_joint_frictionloss
        model.dof_frictionloss[11] = ankle_joint_frictionloss
        model.dof_frictionloss[13] = ankle_joint_frictionloss
